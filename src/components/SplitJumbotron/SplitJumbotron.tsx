...
const JumbotronTile = ({ colour, Icon, title, subtitle }: IJumbotronTileProps) => (
  <JumbotronTileContainer colour={colour} to="/">
    ...
    <StyledSubtitle colour={colour === '#FFFFFF' ? '#272932' : '#FFFFFF'}>
      {subtitle}
    </StyledSubtitle>
...
const DeviceIcon = () => (
  ...
  >
    <path
      fill-rule="evenodd"
      clip-rule="evenodd"
      d="M32 16H176V0H32C23.2 0 16 7.2 16 16V104H0V128H112V104H32V16ZM184 32H136C131.6 32 128 35.6 128 40V120C128 124.4 131.6 128 136 128H184C188.4 128 192 124.4 192 120V40C192 35.6 188.4 32 184 32ZM144 104H176V48H144V104Z"
      fill="black"
      fill-opacity="0.87"
    />
  </svg>
...
const SplitJumbotron = () => (
  <SplitJumbotronContainer>
    <JumbotronTile
      ...
      subtitle="Expert tech leadership for your business"
    />
    <JumbotronTile
      colour="#FFFFFF"
      Icon={DeviceIcon}
      title="Development"
      subtitle="Software done properly"
    />
    <JumbotronTile
      colour="#DD5F49"
      Icon={PeopleIcon}
